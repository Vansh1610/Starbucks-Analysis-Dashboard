d3.csv("../data/Starbucks_World_Stats.csv").then(function(data) {
    ...
    var svg = d3.select('#bar_charts_1').append('svg')
    ...
    const barTooltip = d3.select("body").append("div")
        ...
        function update() {
            ...
            filteredData = data.sort((a, b) => d3.descending(a.no_Starbucks, b.no_Starbucks)).slice(0, nCountries);
            ...
            svg.append("text")
                ...
                .text("Starbucks Statistics - Top 5 Countries");
